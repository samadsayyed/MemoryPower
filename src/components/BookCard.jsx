...
const BookCard = () => {
  ...
  return (
    <div className=" shadow-2xl md:w-[35vw] m-6 bg-white h-96 p-3 rounded-3xl items-center flex flex-col">
      ...
      <table className=" w-full">
        <tr>
          {arr.map((value,index) => (
            <td className=" border-[1px] items-center justify-center hover:bg-[#fc8c1c] hover:text-white duration-500">
